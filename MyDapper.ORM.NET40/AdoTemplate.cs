...
namespace MyDapper.ORM
{
    public class AdoTemplate : IAdoTemplate
    {
        ...
        public int Update<T>(T t)
        {
            try
            {
                string sql = SqlGenerator.GetUpdateSql<T>();
                return DbConnection.Execute(sql, t);
            }
            catch (Exception ex)
            {
        ...
        /// <param name="hs"></param>
        /// <returns></returns>
        public List<T> GetList<T, W>(W where)
        {
            try
            {
                string sql = SqlGenerator.GetSelectSql<T, W>(where);
        ...
        /// <param name="orderBy">排序</param>
        /// <returns></returns>
        public PageList<T> GetPageList<T, W>(W where, int pageIndex, int pageSize, string orderBy)
        {
            try
            {
        ...
        /// <param name="orderBy">排序</param>
        /// <returns></returns>
        public PageList<T> GetPageList<T,W>(string sql, W where, int pageIndex, int pageSize, string orderBy)
        {
            try
            {
                int totalCount = Convert.ToInt32(DbConnection.ExecuteScalar(sql, where));
        ...
        /// <typeparam name="T"></typeparam>
        /// <returns></returns>
        public int GetCount<T, W>(W where)
        {
            try
            {
